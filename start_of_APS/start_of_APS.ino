...
/////////////////////////////////////////////////////////////////////////////
// 받아온 값으로 모드에 따라 DC모터 제어하는 로직 설계 
// 처음엔 받아올 값이 없어서 임시로 조도 센서로 값 받아오는 것으로 가정하고 코드 작성
// 추후 초음파 센서 추가하면서 거기에 맞게 코드 변경
// 이후 여러개의 보드를 사용 하면서 통신 코드 파일에 모터 제어 코드를 통합 이식

// 이후엔 병헌, 용수 컴퓨터에서 숫자 값들을 하드웨어에 맞게 바꾸어 가며 프로젝트함
////////////////////////////////////////////////////////////////////////////////
